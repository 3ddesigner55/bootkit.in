          ...
          <Container className="py-4 sm:py-8">
            <div className="mb-5 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[var(--text-muted)]">
                  Customize notifications, display, and preferences
                </p>
              </div>
            </div>
            ...
            <div className="grid gap-6 lg:grid-cols-3">
              <div className="space-y-6 lg:col-span-2">
                {/* General Settings */}
                <section className="rounded-2xl border border-[var(--border)] bg-white p-5 shadow-xs">
                  <SectionTitle
                    icon={Languages}
                    ...
                    {[
                      ...
                      <button
                        ...
                        onClick={() =>
                          updateSetting(
                            "language",
                            item.code as AppLanguage
                          )
                        }
                        className={`flex h-11 items-center justify-between rounded-xl border px-3 text-xs font-bold transition ${
                          settings.language === item.code
                            ? "border-[var(--primary)] bg-[var(--surface-soft)] text-[var(--primary)]"
                            : "border-[var(--border)] text-[var(--text-primary)] hover:border-[var(--primary-light)]"
                        }`}
                      >
                        {item.label}
                        {settings.language === item.code && (
