      ...
      <main className="flex-1 py-8">
        <Container className="max-w-4xl">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-xl font-black text-[var(--text-primary)]">Add New Promotional Banner</h1>
              <p className="text-xs text-[var(--text-muted)]">Configure banner creative, target route, and display order</p>
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="sm:col-span-2">
                  ...
                  <input
                    type="text"
                    name="subtitle"
                    placeholder="e.g. Up to 40% off on premium Ratnagiri Alphonso"
                    value={form.subtitle}
                    onChange={handleChange}
                    className="w-full h-10 px-3 border border-[var(--border)] rounded-xl text-xs outline-none focus:border-[var(--primary)]"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    name="buttonLink"
                    required
                    placeholder="e.g. /products or /category/fruits"
